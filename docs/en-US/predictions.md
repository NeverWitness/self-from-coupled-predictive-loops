...
The model involves the following key variables:
...
## 3. Predictions Related to Continuity Error
...
* The deviation between current state and predicted trajectory increases
...
## 4. Predictions Related to the Predictive System

---

### Prediction 3: Disruption of prediction → reduced agency
...
* Actions are less likely to be attributed to the self
* Sense of agency decreases
...
## 5. Predictions Related to Signal Coupling
...
## 6. Predictions Related to Perturbation

---

### Prediction 7: Moderate perturbation → optimal system stability
...
### Prediction 8: Low perturbation → behavioral rigidity
...
## 7. Predictions Related to Trajectory Selection
...
### Prediction 12: Changes in temporal integration window → changes in continuity
...
## 9. Predictions Related to Compression

---

### Prediction 13: Reduced compression → unstable self-structure

If:

* Historical trajectories cannot be effectively compressed
...
* Trajectories become more stable
* The self becomes more consistent

---

## 10. Predictions Related to First-Person Expression

---

### Prediction 15: Changes in output interface → changes in self-expression
...
## 12. Experimental Directions (Preliminary)
